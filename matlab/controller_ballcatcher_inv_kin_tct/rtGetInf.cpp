...
real_T Ccontroller_ballcatcher_inv_kin::rtGetInf (void)
  {
...
real32_T Ccontroller_ballcatcher_inv_kin::rtGetInfF (void)
  {
    IEEESingle infF;
...
real_T Ccontroller_ballcatcher_inv_kin::rtGetMinusInf (void)
  {
    size_t bitsPerReal = sizeof(real_T) * (NumBitsPerChar);
    real_T minf = 0.0;
    if (bitsPerReal == 32U) {
...
real32_T Ccontroller_ballcatcher_inv_kin::rtGetMinusInfF (void)
  {
    IEEESingle minfF;
