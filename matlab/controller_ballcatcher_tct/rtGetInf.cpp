...
real_T Ccontroller_ballcatcher::rtGetInf (void)
  {
...
real32_T Ccontroller_ballcatcher::rtGetInfF (void)
  {
    IEEESingle infF;
...
real_T Ccontroller_ballcatcher::rtGetMinusInf (void)
  {
    size_t bitsPerReal = sizeof(real_T) * (NumBitsPerChar);
    real_T minf = 0.0;
    if (bitsPerReal == 32U) {
...
real32_T Ccontroller_ballcatcher::rtGetMinusInfF (void)
  {
    IEEESingle minfF;
