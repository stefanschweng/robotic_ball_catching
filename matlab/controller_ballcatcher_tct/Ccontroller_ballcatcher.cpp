...
///////////////////////////////////////////////////////////////////////////////
// Constructor
Ccontroller_ballcatcher::Ccontroller_ballcatcher() : CTcMatSimModuleBase(1,NUMST)
{
	_InstanceCnt++;
}

// Destructor
Ccontroller_ballcatcher::~Ccontroller_ballcatcher()
{
	_InstanceCnt--;
}
...
// Instance counter
///////////////////////////////////////////////////////////////////////////////
int Ccontroller_ballcatcher::GetInstanceCnt(){
	return _InstanceCnt;
}
int Ccontroller_ballcatcher::_InstanceCnt = 0;

///////////////////////////////////////////////////////////////////////////////
// Provided interfaces map
BEGIN_INTERFACE_MAP(Ccontroller_ballcatcher)
...
///////////////////////////////////////////////////////////////////////////////
// Init -> PreOp
HRESULT Ccontroller_ballcatcher::SetObjStateIP(ITComObjectServer* ipSrv,PTComInitDataHdr pInitData){
	...
	m_ModelParameters = controller_ballcatcher_P;
...
///////////////////////////////////////////////////////////////////////////////
// PreOp -> Init
HRESULT Ccontroller_ballcatcher::SetObjStatePI(){
	return S_OK;
}
...
///////////////////////////////////////////////////////////////////////////////
// PreOp -> SaveOp
HRESULT Ccontroller_ballcatcher::SetObjStatePS(PTComInitDataHdr pInitData)
{
	HRESULT hr = S_OK;
	...
	// (Re)Initialize model
	if (SUCCEEDED(hr))
		TcMatSimTryExeptCodeHr(controller_ballcatcher();,hr,"controller_ballcatcher()");
	if (SUCCEEDED(hr))
	...
	if (SUCCEEDED(hr))
		hr = QueryExtModeServer(&m_ipExtModeServer,this,true,sizeof(Ccontroller_ballcatcher));
...
///////////////////////////////////////////////////////////////////////////////
// SaveOp -> PreOp
HRESULT Ccontroller_ballcatcher::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
///////////////////////////////////////////////////////////////////////////////
// SaveOp -> Op
HRESULT Ccontroller_ballcatcher::SetObjStateSO() {
	HRESULT hr = S_OK;
	return hr;
}
...
///////////////////////////////////////////////////////////////////////////////
// Op -> SaveOp
HRESULT Ccontroller_ballcatcher::SetObjStateOS() {
...
///////////////////////////////////////////////////////////////////////////////
HRESULT Ccontroller_ballcatcher::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	HRESULT hr = S_OK;
...
///////////////////////////////////////////////////////////////////////////////
HRESULT Ccontroller_ballcatcher::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	HRESULT hr = S_OK;
	TCMATSIM_FPUCTRL_INIT
	TcTry{
...
///////////////////////////////////////////////////////////////////////////////
// Set parameters of Ccontroller_ballcatcher
BEGIN_SETOBJPARA_MAP(Ccontroller_ballcatcher)
...
///////////////////////////////////////////////////////////////////////////////
// Get parameters of Ccontroller_ballcatcher
BEGIN_GETOBJPARA_MAP(Ccontroller_ballcatcher)
...
///////////////////////////////////////////////////////////////////////////////
// Get watch entries of Ccontroller_ballcatcher
BEGIN_OBJPARAWATCH_MAP(Ccontroller_ballcatcher)
...
///////////////////////////////////////////////////////////////////////////////
// Get data area members of Ccontroller_ballcatcher
BEGIN_OBJDATAAREA_MAP(Ccontroller_ballcatcher)
...
// ITcADI
///////////////////////////////////////////////////////////////////////////////
IMPLEMENT_ITCADI(Ccontroller_ballcatcher)

///////////////////////////////////////////////////////////////////////////////
// ITcWatchSource
///////////////////////////////////////////////////////////////////////////////
IMPLEMENT_ITCWATCHSOURCE(Ccontroller_ballcatcher)
...
///////////////////////////////////////////////////////////////////////////////
HRESULT Ccontroller_ballcatcher::InitMembers(){
	...
	memset(&m_controller_ballcatcher_47_rt_ExtModeInfo,0,sizeof(m_controller_ballcatcher_47_rt_ExtModeInfo));
	memset(&m_controller_ballcatcher_117_dtInfo,0,sizeof(m_controller_ballcatcher_117_dtInfo));

	m_ModuleInfo.ClassId.Data1 = 0xfc150844;
	m_ModuleInfo.ClassId.Data2 = 0x4666;
	m_ModuleInfo.ClassId.Data3 = 0x4420;
	m_ModuleInfo.ClassId.Data4[0] = 0x8f;
	m_ModuleInfo.ClassId.Data4[1] = 0xdb;
	m_ModuleInfo.ClassId.Data4[2] = 0x90;
	m_ModuleInfo.ClassId.Data4[3] = 0xb5;
	m_ModuleInfo.ClassId.Data4[4] = 0xfc;
	m_ModuleInfo.ClassId.Data4[5] = 0x68;
	m_ModuleInfo.ClassId.Data4[6] = 0x4e;
	m_ModuleInfo.ClassId.Data4[7] = 0xee;
	m_ModuleInfo.BuildTimeStamp = 1602620296;
	m_ModuleInfo.ModelCheckSum[0] = 1964384509;
	m_ModuleInfo.ModelCheckSum[1] = 2064986566;
	m_ModuleInfo.ModelCheckSum[2] = 3643458704;
	m_ModuleInfo.ModelCheckSum[3] = 72446283;
	m_ModuleInfo.ModelVersion[0] = 1;
	m_ModuleInfo.ModelVersion[1] = 3592;
...
///////////////////////////////////////////////////////////////////////////////
HRESULT Ccontroller_ballcatcher::CheckAndAdaptCycleTimes(){
