...
#include <math.h>
#include "Chart3_sf.h"
#include "Chart3_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"

/* Named constants for Chart: '<Root>/Chart3' */
#define Chart3_IN_CATCH                ((uint8_T)1U)
#define Chart3_IN_GO_TO_START_FROM_NO_CATCH ((uint8_T)2U)
#define Chart3_IN_INIT                 ((uint8_T)3U)
#define Chart3_IN_INIT_GOTO_START      ((uint8_T)4U)
#define Chart3_IN_NO_ACTIVE_CHILD      ((uint8_T)0U)
#define Chart3_IN_NO_VALID_BALL_VALUE  ((uint8_T)5U)
#define Chart3_IN_READY                ((uint8_T)6U)
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *Chart3_malloc(SimStruct *S);
...
static void Chart3_estimate_parabola_d(real_T t_in, const real_T point_in[3],
  const struct_drdASX3xMwFWgTYNtyjTdF *b_estimator_init_struct, real_T init,
  sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *estimations, real_T *prediction_update,
  SimStruct * const S);

/* Forward declaration for local functions */
static boolean_T Chart3_isBallValueValid(const real_T data_point[3]);
  ...
  SimStruct * const S)
{
  ...
  *prediction_update = 0.0;
  ...
  if ((!((boolean_T *)ssGetDWork(S, 19))[0]) || (init != 0.0)) {
    /* 'estimate_parabola:10' px_est_last = estimator_init_struct.px_est_last; */
    ((real_T *)ssGetDWork(S, 12))[0] = b_estimator_init_struct->px_est_last[0];
    ((real_T *)ssGetDWork(S, 12))[1] = b_estimator_init_struct->px_est_last[1];
    ...
    /* 'estimate_parabola:13' py_est_last = estimator_init_struct.py_est_last; */
    ((real_T *)ssGetDWork(S, 14))[0] = b_estimator_init_struct->py_est_last[0];
    ((real_T *)ssGetDWork(S, 14))[1] = b_estimator_init_struct->py_est_last[1];
    ...
    /* 'estimate_parabola:16' pz_est_last = estimator_init_struct.pz_est_last; */
    ((real_T *)ssGetDWork(S, 16))[0] = b_estimator_init_struct->pz_est_last[0];
    ((real_T *)ssGetDWork(S, 16))[1] = b_estimator_init_struct->pz_est_last[1];
    ...
    /* 'estimate_parabola:20' estimations_last.x0_est = 0; */
    (*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).x0_est = 0.0;

    /* 'estimate_parabola:21' estimations_last.vx0_est = 0; */
    (*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).vx0_est = 0.0;

    /* 'estimate_parabola:22' estimations_last.y0_est = 0; */
    (*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).y0_est = 0.0;

    /* 'estimate_parabola:23' estimations_last.vy0_est = 0; */
    (*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).vy0_est = 0.0;

    /* 'estimate_parabola:24' estimations_last.z0_est = 0; */
    (*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).z0_est = 0.0;

    /* 'estimate_parabola:25' estimations_last.vz0_est = 0; */
    (*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).vz0_est = 0.0;
  }

  /* 'estimate_parabola:28' if ((point_in(1) == 0 && point_in(2) == 0 && point_in(3) == 0)) */
  if ((point_in[0] == 0.0) && (point_in[1] == 0.0) && (point_in[2] == 0.0)) {
    /* 'estimate_parabola:29' estimations = estimations_last; */
    *estimations = ((sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3))[0];
  } else {
    /* 'estimate_parabola:30' else */
    /* 'estimate_parabola:32' x_in = point_in(1); */
    /* 'estimate_parabola:33' y_in = point_in(2); */
    /* 'estimate_parabola:34' z_in = point_in(3)+g/2*t_in^2; */
    /* 'estimate_parabola:37' f1 = @(x) 1; */
    /* 'estimate_parabola:38' fx = @(x) x; */
    /* 'estimate_parabola:40' s_i = [ f1(t_in);... */
    /* 'estimate_parabola:41'              fx(t_in) ]; */
    /* 'estimate_parabola:44' q = estimator_init_struct.q; */
    /* 'estimate_parabola:46' kx_i = (Px_last*s_i)/(q + s_i'*Px_last*s_i); */
    ...
    /* 'estimate_parabola:47' Px_i = (1/q)*(Px_last - kx_i*s_i'*Px_last); */
    y_tmp = 1.0 / b_estimator_init_struct->q;

    /* 'estimate_parabola:48' px_est = px_est_last + kx_i*(x_in - s_i'*px_est_last); */
    ...
    /* 'estimate_parabola:50' estimations.x0_est = px_est(1); */
    estimations->x0_est = ((real_T *)ssGetDWork(S, 12))[0];

    /* 'estimate_parabola:51' estimations.vx0_est = px_est(2); */
    estimations->vx0_est = ((real_T *)ssGetDWork(S, 12))[1];

    /* 'estimate_parabola:54' ky_i = (Py_last*s_i)/(q + s_i'*Py_last*s_i); */
    ...
    /* 'estimate_parabola:55' Py_i = (1/q)*(Py_last - ky_i*s_i'*Py_last); */
    /* 'estimate_parabola:56' py_est = py_est_last + ky_i*(y_in - s_i'*py_est_last); */
    ...
    /* 'estimate_parabola:58' estimations.y0_est = py_est(1); */
    estimations->y0_est = ((real_T *)ssGetDWork(S, 14))[0];

    /* 'estimate_parabola:59' estimations.vy0_est = py_est(2); */
    estimations->vy0_est = ((real_T *)ssGetDWork(S, 14))[1];

    /* 'estimate_parabola:62' kz_i = (Pz_last*s_i)/(q + s_i'*Pz_last*s_i); */
    ...
    /* 'estimate_parabola:63' Pz_i = (1/q)*(Pz_last - kz_i*s_i'*Pz_last); */
    /* 'estimate_parabola:64' pz_est = pz_est_last + kz_i*(z_in - s_i'*pz_est_last); */
    ...
    /* 'estimate_parabola:66' estimations.z0_est = pz_est(1); */
    estimations->z0_est = ((real_T *)ssGetDWork(S, 16))[0];

    /* 'estimate_parabola:67' estimations.vz0_est = pz_est(2); */
    estimations->vz0_est = ((real_T *)ssGetDWork(S, 16))[1];

    /* 'estimate_parabola:70' px_est_last = px_est; */
    /* 'estimate_parabola:71' Px_last = Px_i; */
    for (i = 0; i < 2; i++) {
      kx_i_0[i] = kx_i[i];
      kx_i_0[i + 2] = kx_i[i] * t_in;
      b_estimator_init_struct_0 = kx_i_0[i + 2];
      tmp[i] = ((real_T *)ssGetDWork(S, 13))[i] - (b_estimator_init_struct_0 *
        ((real_T *)ssGetDWork(S, 13))[1] + kx_i_0[i] * ((real_T *)ssGetDWork(S,
        13))[0]);
      tmp[i + 2] = ((real_T *)ssGetDWork(S, 13))[i + 2] -
        (b_estimator_init_struct_0 * ((real_T *)ssGetDWork(S, 13))[3] + kx_i_0[i]
         * ((real_T *)ssGetDWork(S, 13))[2]);
    }

    ((real_T *)ssGetDWork(S, 13))[0] = y_tmp * tmp[0];
    ((real_T *)ssGetDWork(S, 13))[1] = y_tmp * tmp[1];
    ((real_T *)ssGetDWork(S, 13))[2] = y_tmp * tmp[2];
    ((real_T *)ssGetDWork(S, 13))[3] = y_tmp * tmp[3];

    /* 'estimate_parabola:72' py_est_last = py_est; */
    /* 'estimate_parabola:73' Py_last = Py_i; */
    for (i = 0; i < 2; i++) {
      kx_i_0[i] = ky_i[i];
      kx_i_0[i + 2] = ky_i[i] * t_in;
      b_estimator_init_struct_0 = kx_i_0[i + 2];
      tmp[i] = ((real_T *)ssGetDWork(S, 15))[i] - (b_estimator_init_struct_0 *
        ((real_T *)ssGetDWork(S, 15))[1] + kx_i_0[i] * ((real_T *)ssGetDWork(S,
        15))[0]);
      tmp[i + 2] = ((real_T *)ssGetDWork(S, 15))[i + 2] -
        (b_estimator_init_struct_0 * ((real_T *)ssGetDWork(S, 15))[3] + kx_i_0[i]
         * ((real_T *)ssGetDWork(S, 15))[2]);
    }

    ((real_T *)ssGetDWork(S, 15))[0] = y_tmp * tmp[0];
    ((real_T *)ssGetDWork(S, 15))[1] = y_tmp * tmp[1];
    ((real_T *)ssGetDWork(S, 15))[2] = y_tmp * tmp[2];
    ((real_T *)ssGetDWork(S, 15))[3] = y_tmp * tmp[3];

    /* 'estimate_parabola:74' pz_est_last = pz_est; */
    /* 'estimate_parabola:75' Pz_last = Pz_i; */
    for (i = 0; i < 2; i++) {
      kx_i_0[i] = kz_i[i];
      kx_i_0[i + 2] = kz_i[i] * t_in;
      b_estimator_init_struct_0 = kx_i_0[i + 2];
      tmp[i] = ((real_T *)ssGetDWork(S, 17))[i] - (b_estimator_init_struct_0 *
        ((real_T *)ssGetDWork(S, 17))[1] + kx_i_0[i] * ((real_T *)ssGetDWork(S,
        17))[0]);
      tmp[i + 2] = ((real_T *)ssGetDWork(S, 17))[i + 2] -
        (b_estimator_init_struct_0 * ((real_T *)ssGetDWork(S, 17))[3] + kx_i_0[i]
         * ((real_T *)ssGetDWork(S, 17))[2]);
    }

    ((real_T *)ssGetDWork(S, 17))[0] = y_tmp * tmp[0];
    ((real_T *)ssGetDWork(S, 17))[1] = y_tmp * tmp[1];
    ((real_T *)ssGetDWork(S, 17))[2] = y_tmp * tmp[2];
    ((real_T *)ssGetDWork(S, 17))[3] = y_tmp * tmp[3];

    /* 'estimate_parabola:77' if estimations_last.x0_est ~= estimations.x0_est ||... */
    /* 'estimate_parabola:78'          estimations_last.y0_est ~= estimations.y0_est ||... */
    /* 'estimate_parabola:79'          estimations_last.z0_est ~= estimations.z0_est ||... */
    /* 'estimate_parabola:80'          estimations_last.vx0_est ~= estimations.vx0_est ||... */
    /* 'estimate_parabola:81'          estimations_last.vy0_est ~= estimations.vy0_est ||... */
    /* 'estimate_parabola:82'          estimations_last.vz0_est ~= estimations.vz0_est */
    if (((*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).x0_est !=
         ((real_T *)ssGetDWork(S, 12))[0]) ||
        ((*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).y0_est !=
         ((real_T *)ssGetDWork(S, 14))[0]) ||
        ((*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).z0_est !=
         ((real_T *)ssGetDWork(S, 16))[0]) ||
        ((*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).vx0_est !=
         ((real_T *)ssGetDWork(S, 12))[1]) ||
        ((*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).vy0_est !=
         ((real_T *)ssGetDWork(S, 14))[1]) ||
        ((*(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3)).vz0_est !=
         ((real_T *)ssGetDWork(S, 16))[1])) {
      /* 'estimate_parabola:83' prediction_update = 1; */
      *prediction_update = 1.0;
    }

    /* 'estimate_parabola:86' estimations_last = estimations; */
    ((sDzCfTiIapKTB3mCVdDRUZC_Chart3_T *)ssGetDWork(S, 3))[0] = *estimations;
  }
}
  ...
  rtu_init_number_of_samples, B_estimate_parabola_Chart3_T *localB)
{
  ...
  real_T t_move_start;
  real_T t_start_g;
  sDzCfTiIapKTB3mCVdDRUZC_Chart3_T estimations;

  /* MATLAB Function: '<S2>/Parabola Estimator' */
  /* MATLAB Function 'Chart3/estimate_parabola/Parabola Estimator': '<S3>:1' */
  ...
  if ((rtu_init != 0.0) || (!((boolean_T *)ssGetDWork(S, 18))[0])) {
  ...
  if (((real_T *)ssGetDWork(S, 7))[0] == 0.0) {
    /* '<S3>:1:21' if t_in >= t_catch_predict_p(1) && t_in <= t_catch_predict_p(2) */
    if ((rtu_t_in >= ((real_T *)ssGetDWork(S, 5))[0]) && (rtu_t_in <= ((real_T *)
          ssGetDWork(S, 5))[1])) {
      /* '<S3>:1:22' use_pred_p = 1; */
      ((real_T *)ssGetDWork(S, 4))[0] = 1.0;

      /* '<S3>:1:23' g = 9.81; */
      /* '<S3>:1:25' [estimations,prediction_update]=estimate_parabola(t_for_est,point_in,estimator_init_struct,init); */
      Chart3_estimate_parabola_d(t_for_est, rtu_point_in,
        &Chart3_ConstP.ParabolaEstimator_estimator_init_struct, rtu_init,
        &estimations, &localB->prediction_update, (SimStruct * const )S);

      /* '<S3>:1:26' x0_est = estimations.x0_est; */
      /* '<S3>:1:27' vx0_est = estimations.vx0_est; */
      /* '<S3>:1:28' y0_est = estimations.y0_est; */
      /* '<S3>:1:29' vy0_est = estimations.vy0_est; */
      /* '<S3>:1:30' z0_est = estimations.z0_est; */
      /* '<S3>:1:31' vz0_est = estimations.vz0_est; */
      /* '<S3>:1:34' x = @(ti,x0_t,vx0_t) ( x0_t + vx0_t*ti ); */
      /* '<S3>:1:35' y = @(ti,y0_t,vy0_t) ( y0_t + vy0_t*ti ); */
      /* '<S3>:1:36' z = @(ti,z0_t,vz0_t) ( z0_t + vz0_t*ti - (g/2)*ti.^2 ); */
      /* '<S3>:1:39' x_p = @(vx0_t) ( vx0_t ); */
      /* '<S3>:1:40' y_p = @(vy0_t) ( vy0_t ); */
      /* '<S3>:1:41' z_p = @(ti,vz0_t) ( vz0_t - g*ti ); */
      /* '<S3>:1:44' za = -(g/2); */
      /* '<S3>:1:45' zb = vz0_est; */
      /* '<S3>:1:46' zc = z0_est; */
      /* '<S3>:1:48' descriminant = -4*za*zc+4*za*height_of_catch+zb^2; */
      t_for_est = (19.62 * estimations.z0_est + -15.696000000000002) +
        estimations.vz0_est * estimations.vz0_est;

      /* '<S3>:1:49' if descriminant >= 0 */
      if (t_for_est >= 0.0) {
        /* '<S3>:1:50' t_zd = -(zb+sqrt(descriminant))/(2*za); */
      ...
      /* '<S3>:1:56' x_out = x(t_zd,x0_est,vx0_est); */
      /* '<S3>:1:57' y_out = y(t_zd,y0_est,vy0_est); */
      /* '<S3>:1:58' z_out = z(t_zd,z0_est,vz0_est); */
      /* '<S3>:1:59' pd__ = [x_out,y_out,z_out]; */
      ...
      /* '<S3>:1:62' x_out_p = x_p(vx0_est); */
      /* '<S3>:1:63' y_out_p = y_p(vy0_est); */
      /* '<S3>:1:64' z_out_p = z_p(t_zd,vz0_est); */
      /* '<S3>:1:65' pd_p__ = [x_out_p,y_out_p,z_out_p]*(-1); */
      ...
      /* '<S3>:1:68' t_catch_predict_p = [t_start_g,t_zd+t_start]; */
      ((real_T *)ssGetDWork(S, 5))[0] = t_start_g;
      ((real_T *)ssGetDWork(S, 5))[1] = ((real_T *)ssGetDWork(S, 6))[0] +
        rtu_t_start;
    } else {
      /* '<S3>:1:69' else */
      /* '<S3>:1:70' use_pred_p = 0; */
      ((real_T *)ssGetDWork(S, 4))[0] = 0.0;

      /* '<S3>:1:71' [estimations,~]=estimate_parabola(t_for_est,point_in,estimator_init_struct,init); */
      Chart3_estimate_parabola_d(t_for_est, rtu_point_in,
        &Chart3_ConstP.ParabolaEstimator_estimator_init_struct, rtu_init,
      ...
      /* '<S3>:1:74' y_out = 0; */
      /* '<S3>:1:75' z_out = 0; */
      /* '<S3>:1:76' pd__ = [x_out,y_out,z_out]; */
      /* '<S3>:1:78' x_out_p = 0; */
      /* '<S3>:1:79' y_out_p = 0; */
      /* '<S3>:1:80' z_out_p = 0; */
      /* '<S3>:1:81' pd_p__ = [x_out_p,y_out_p,z_out_p]*(-1); */
      ((real_T *)ssGetDWork(S, 8))[0] = 0.0;
      ((real_T *)ssGetDWork(S, 9))[0] = -0.0;
      ((real_T *)ssGetDWork(S, 8))[1] = 0.0;
      ((real_T *)ssGetDWork(S, 9))[1] = -0.0;
  ...
  /* '<S3>:1:86' use_pred = use_pred_p; */
  localB->use_pred = ((real_T *)ssGetDWork(S, 4))[0];

  /* '<S3>:1:87' t_catch_predict = t_catch_predict_p; */
  ...
  /* '<S3>:1:94' if i == timing.cycle_time_ratio */
  if (((real_T *)ssGetDWork(S, 7))[0] == 80.0) {
    /* '<S3>:1:95' i = 0; */
    ((real_T *)ssGetDWork(S, 7))[0] = 0.0;
  }

  /* '<S3>:1:98' if t_in == t_in_last */
  if (rtu_t_in == ((real_T *)ssGetDWork(S, 10))[0]) {
    /* '<S3>:1:99' t_cnt=t_cnt+1; */
...
void Chart3_estimate_parabola_Term(SimStruct *const S)
{
}

/*
 * Function for Chart: '<Root>/Chart3'
...
static void mdlInitializeConditions(SimStruct *S)
{
  if (ssIsFirstInitCond(S)) {
    B_Chart3_T *_rtB;
    _rtB = ((B_Chart3_T *) ssGetLocalBlockIO(S));
    ((uint32_T *)ssGetDWork(S, 0))[0] = 0U;
    ((uint8_T *)ssGetDWork(S, 1))[0] = 0U;
    ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_NO_ACTIVE_CHILD;

    /* SystemInitialize for Chart: '<Root>/Chart3' incorporates:
     *  SubSystem: '<S1>/estimate_parabola'
     */
    Chart3_estimate_parabola_Init((SimStruct * const )S,
      &_rtB->estimate_parabola);
  } else {                             /* SystemReset for Chart: '<Root>/Chart3' */
    ((uint32_T *)ssGetDWork(S, 0))[0] = 0U;
    ((uint8_T *)ssGetDWork(S, 1))[0] = 0U;
    ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_NO_ACTIVE_CHILD;
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  if (ssIsSampleHit(S, 0, 0)) {
    ...
    if (((uint8_T *)ssGetDWork(S, 1))[0] == 0U) {
      ...
      /* Transition: '<S1>:27' */
      ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_INIT;
      ...
      switch (((uint8_T *)ssGetDWork(S, 2))[0]) {
       case Chart3_IN_CATCH:
        ...
        if (*((const boolean_T **)ssGetInputPortSignalPtrs(S, 3))[0]) {
          ...
          if (*((const real_T **)ssGetInputPortSignalPtrs(S, 0))[0] >
            ...
            /* '<S1>:17:4' trajectory_update = 0; */
            _rtB->trajectory_update = 0.0;
            ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_NO_VALID_BALL_VALUE;
            ((uint32_T *)ssGetDWork(S, 0))[0] = 0U;
            ...
            Chart3_estimate_parabola((SimStruct * const )S, _rtB->t_in,
              _rtB->t_start_b, _rtB->point_in, _rtB->init,
       ...
       case Chart3_IN_GO_TO_START_FROM_NO_CATCH:
        _rtB->state = 4.0;
        ...
        if (*((const boolean_T **)ssGetInputPortSignalPtrs(S, 3))[0]) {
          ...
          if (((uint32_T *)ssGetDWork(S, 0))[0] >= 200000U) {
            /* Transition: '<S1>:25' */
            ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_READY;
       ...
       case Chart3_IN_INIT:
        ...
        if ((*((const real_T **)ssGetInputPortSignalPtrs(S, 2))[0] != 0.0) &&
          ...
          /* Transition: '<S1>:107' */
          ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_INIT_GOTO_START;
          ((uint32_T *)ssGetDWork(S, 0))[0] = 0U;
       ...
       case Chart3_IN_INIT_GOTO_START:
       ...
       case Chart3_IN_NO_VALID_BALL_VALUE:
        _rtB->state = 3.0;
        ...
        if (*((const boolean_T **)ssGetInputPortSignalPtrs(S, 3))[0]) {
          ...
          /* '<S1>:88:1' sf_internal_predicateOutput = after(1,sec); */
          if (((uint32_T *)ssGetDWork(S, 0))[0] >= 20000U) {
            /* Transition: '<S1>:88' */
            ((uint8_T *)ssGetDWork(S, 2))[0] =
              Chart3_IN_GO_TO_START_FROM_NO_CATCH;
            ((uint32_T *)ssGetDWork(S, 0))[0] = 0U;
       ...
       default:
        ...
        if (*((const boolean_T **)ssGetInputPortSignalPtrs(S, 3))[0]) {
          ...
          if (Chart3_isBallValueValid(*(const real_T **)ssGetInputPortSignalPtrs
               (S, 1))) {
            /* Transition: '<S1>:26' */
            ((uint8_T *)ssGetDWork(S, 2))[0] = Chart3_IN_CATCH;
            ...
            /* Simulink Function 'estimate_parabola': '<S1>:52' */
            _rtB->t_in = *((const real_T **)ssGetInputPortSignalPtrs(S, 0))[0];
            _rtB->t_start_b = *((const real_T **)ssGetInputPortSignalPtrs(S, 0))
              [0];
            _rtB->point_in[0] = *((const real_T **)ssGetInputPortSignalPtrs(S, 1))
              [0];
            _rtB->point_in[1] = *((const real_T **)ssGetInputPortSignalPtrs(S, 1))
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  {
    int id = ssRegisterDataType(S, "sDzCfTiIapKTB3mCVdDRUZC_Chart3_T");
    if (id == INVALID_DTYPE_ID )
      return;
    if (!ssSetDataTypeSize(S, id, sizeof(sDzCfTiIapKTB3mCVdDRUZC_Chart3_T)))
      return;
